...
func InterfaceAcceptingAddressVariable() {
	var b Book                                 // Delcare instance of Book
	var m Magazine                             // Declare instance of Magazine
	b.Assign("Jack Rabbit", "Book of Rabbits") // Assign values to b via method
	m.Assign("Rabbut Weekly Weekly", 26)       // Assign values to m via method
	...
	i.Print() // Show book values via interface
